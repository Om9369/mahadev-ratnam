        ...
        {cart.cart.length > 0 && (
          <div className="border-t border-[#E8D8B8] p-6 bg-[#FCF8F3]">
            ...
            <div className="space-y-3">
              ...
              <a
                href={`https://wa.me/919369895157?text=Hello%20Mahadev%20Ratnam%2C%20I%20want%20to%20place%20an%20order.%0A%0ACart%20Items%3A%0A${cart.cart.map(item => `- ${item.name} (${item.purity}) x${item.quantity}`).join('%0A')}%0A%0ATotal%3A%20₹${cart.cartTotal.toLocaleString('en-IN')}`}
                target="_blank"
